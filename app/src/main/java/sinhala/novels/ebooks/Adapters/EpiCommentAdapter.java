...
public class EpiCommentAdapter extends RecyclerView.Adapter<EpiCommentAdapter.viewHolder> {

    private final Context context;
    private final ArrayList<EpiCommentModel> arrayList;

    public EpiCommentAdapter( ArrayList<EpiCommentModel> arrayList,Context context){
    ...
    private void showLongClickDialog(int position) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                DocumentReference documentReference= FirebaseFirestore.getInstance().collection("EpisodeComments").document(String.valueOf(arrayList.get(position).getId()));
